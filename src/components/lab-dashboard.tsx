  ...
  const labProjects = [
    {
      ...
      showcase: {
        eyebrow: "Automated Build",
        handwrittenLabel: "AtmoLens",
        title: "Atmospheric",
        accentTitle: "Intelligence",
        description:
          "An automated GIS pipeline that fetches ECCC synoptic charts and transforms them into high-contrast, color-enhanced readable maps with a 7-day archive.",
        techStack: "Next.js / ECCC / GLSL",
    ...
    },
    {
      ...
      initialClipPercentage: 20,
      showcase: {
        eyebrow: "Spatial Narrative",
        handwrittenLabel: "ArcGIS",
        title: "Conservation",
        accentTitle: "Storytelling",
        description:
          "A narrative GIS solution optimizing bear sighting data collection via Survey123, paired with immersive storytelling for wildlife conservation efforts.",
        techStack: "ArcGIS / Survey123 / UX",
        domain: "Wildlife GIS",
