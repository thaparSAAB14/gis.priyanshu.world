  ...
  return (
    <section className="h-full snap-y snap-mandatory overflow-y-scroll">
      <div className="relative flex h-full w-full flex-col items-center justify-center gap-5">
        <Link001 href="mailto:hi@priyanshu.world">hi@priyanshu.world</Link001>
        <Link002 href="mailto:hi@priyanshu.world">hi@priyanshu.world</Link002>
        <Link003 href="mailto:hi@priyanshu.world">hi@priyanshu.world</Link003>
        <Link004 href="mailto:hi@priyanshu.world">hi@priyanshu.world</Link004>
        <Link005 href="mailto:hi@priyanshu.world">hi@priyanshu.world</Link005>
      </div>
    </section>
  );
};
  ...
  return (
    <a
      ...
      className={cn(
        "group relative flex items-center",
        className,
        "before:pointer-events-none before:absolute before:left-0 before:w-full before:bg-card before:content-['']",
